...
def main():
    ...
    fq_histogram_clean_fig_fq = px.histogram(df_clean, x="FQ_Month_Range", color="Sales Category", facet_col="State", barmode="group", labels={
                                             "FQ_Month_Range": "FQ-2"}, title="Fiscal Quarterly Sales Analysis using Histogram",)
